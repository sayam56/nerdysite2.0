        	...
        	<div class="row clearfix">
                ...
                <div class="content-side col-lg-8 col-md-12 col-sm-12">
					...
					<div class="news-detail">
						<div class="inner-box">
							<div class="image">
								<img src="images/resource/resource/news-7.jpg" alt="" />
							</div>
							<div class="lower-content">
								<ul class="post-meta">
									<li><span class="icon fa fa-user"></span> Pablo Villalpando</li>
									<li><span class="icon fa fa-calendar"></span> November 21, 2021</li>
								</ul>
								<h2>Absolute Links vs. Relative Links – SEO Intrinsic Value</h2>
								...
								<blockquote>
									...
									<span class="author-name">Bayard Herbert</span>
								</blockquote>
								<div class="row clearfix">
									<div class="column col-lg-6 col-md-6 col-sm-12">
										<div class="image">
											<img src="images/resource/resource/news-12.jpg" alt="" />
										</div>
									</div>
									<div class="column col-lg-6 col-md-6 col-sm-12">
										<div class="image">
											<img src="images/resource/resource/news-13.jpg" alt="" />
										</div>
									</div>
								</div>
						...
						<div class="authors-box">
							<div class="author-inner">
								<div class="thumb"><img src="images/resource/resource/author-8.jpg" alt=""></div>
								<div class="author">Author</div>
								<h4 class="name">Manika Rock</h4>
								<div class="text">He is attended the State University of New York at Oswego where he majored in English Literature and Creative Writing.</div>
						...
						<div class="comments-area">
							<div class="group-title"><h4>Read Comments</h4></div>
							<!--Comment Box-->
							<div class="comment-box">
								<div class="comment">
									<div class="author-thumb"><img src="images/resource/resource/author-1.png" alt=""></div>
									<div class="comment-inner">
										<div class="comment-info clearfix">Steven Rich – Dec 17, 2021</div>
										<div class="rating">
							...
							<div class="comment-box reply-comment">
								<div class="comment">
									<div class="author-thumb"><img src="images/resource/resource/author-2.png" alt=""></div>
									<div class="comment-inner">
										<div class="comment-info clearfix">William Cobus – Dec 20, 2021</div>
										<div class="rating">
											<span class="fa fa-star"></span>
											<span class="fa fa-star"></span>
											<span class="fa fa-star"></span>
						...
						<div class="comment-form">	
							<div class="group-title"><h4>Add Your Reviews</h4></div>
