...
<head>
<meta charset="utf-8">
<title>NerdEvolution || Not Found</title>
<!-- Stylesheets -->
    	...
    	<div class="auto-container">
        	<div class="content">
            	<div class="error-image">
					<img src="images/resource/404.webp" alt="" />
				</div>
                <h2>Oops.... Page Not Found</h2>
                <div class="text">Sorry, but the page you are looking for does not exist.</div>
                <a href="/" class="theme-btn btn-style-five"><span class="txt">Go to home page</span></a>
            </div>
        </div>
    </section>
    <!-- End Error Section -->
							...
							<div class="footer-column col-lg-5 col-md-6 col-sm-12">
								<div class="footer-widget links-widget">
									...
									<ul class="list-style-two">
										<li><span class="icon flaticon-wall-clock"></span>Fri – Tue 06.00pm - 06:00am</li>
