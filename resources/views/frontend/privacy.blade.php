    ...
    <section class="page-title" style="background-image: url(images/background/pattern-16.webp)">
		...
		<div class="auto-container">
            <h2>Privacy Policy for NerdEvolution</h2>
	...
	<section class="privacy-section">
		<div class="auto-container">
			...
			<div class="privacy-content">
				...
				<div class="date">Last updated: June 14, 2021</div>
				...
				<ul class="privacy-list">
					...
					<li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Limited Liability Company, Dhaka, Bangladesh.</li>
					...
					<li>Website refers to NerdEvolution, accessible from https://nerdevolution.tech/</li>
			...
			<div class="privacy-content">
				...
				<ul class="privacy-list">
					...
					<li><b>For business transfers:</b>We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Service, products, services, marketing and your experience.</li>
					<li><b>For other purposes:</b>We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to contact You.</li>
					
					
				</ul>
				<p>We may share Your personal information in the following situations:</p>
				<ul class="privacy-list">
					<li><b>With Service Providers:</b>We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company.</li>
					<li><b>For business transfers:</b>We may share Your information with Our affiliates, in which case we will require those affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other companies that We control or that are under common control with Us.</li>
					<li><b>With Affiliates: </b>We may share Your information with Our business partners to offer You certain products, services or promotions.</li>
					<li><b>With business partners: </b></li>
				...
				<ul class="privacy-lits">
					<li>By email: <a href="mailto:admin@nerdevolution.tech">admin@nerdevolution.tech</a> </li>
				</ul>
			</div>
		</div>
	</section>
