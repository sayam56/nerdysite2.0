...
<head>
<meta charset="utf-8">
<title>NerdEvolution || Software Solutions</title>
					   ...
					   <nav class="main-menu navbar-expand-md">
							...
							<div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
								 <ul class="navigation clearfix">
									  ...
									  <li class="dropdown current"><a>Services</a>
										<ul>
                	...
                	<aside class="sidebar sticky-top">
                        ...
                        <div class="sidebar-widget">
                            <ul class="service-list">
                                ...
                                <li class="current"><a href="software-solutions.html"><span class="color-layer"></span>Software Solutions</a></li>
							...
							<div class="lower-content">
								...
								<div class="two-columns">
									<div class="row clearfix">
										<div class="column col-lg-6 col-md-6 col-sm-12">
											<div class="image">
												<img src="images/Services/service-sub-illustration/APP Dev.webp" alt="" />
											</div>
										</div>
										<div class="column col-lg-6 col-md-6 col-sm-12">
								...
								<div class="two-columns">
									<div class="row clearfix">
										...
										<div class="column col-lg-6 col-md-6 col-sm-12">
											<div class="image">
												<img src="images/Services/service-sub-illustration/Web Dev.webp" alt="" />
											</div>
										</div>
									</div>
								</div>
