...
<head>
<meta charset="utf-8">
<title>NerdEvolution || Case Study</title>
<!-- Stylesheets -->
...
<body class="hidden-bar-wrapper dark-body">
...
<header class="main-header header-style-one">
	...
	<div class="header-upper">
		<div class="auto-container clearfix customHeaderFixer">
			...
			<div class="pull-left logo-box">
				<div class="logo"><a href="/"><img loading="lazy" class="lazy" data-src="images/logo.png" alt="" title=""></a></div>
			</div>
				...
				<nav class="main-menu navbar-expand-md">
					...
					<div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
						<ul class="navigation clearfix">
							...
							<li class="current" style="white-space: nowrap;"><a href="case_study.html">Case Study</a></li>
							<li><a href="contact.html">Contact us</a></li>
							
							<div class="responsiveLogo"><a href="/"><img loading="lazy" class="lazy" data-src="images/logo.png" alt="" title=""></a></div>
	...
	<div class="sticky-header">
		<div class="auto-container clearfix">
			...
			<div class="logo pull-left sticky-logo-desktop">
				<a href="/" title=""><img loading="lazy" class="lazy" data-src="images/logo.png" alt="" title=""></a>
			</div>
			<!--Right Col-->
	...
	<div class="mobile-menu">
		...
		<nav class="menu-box" style="background-color: #161e29;">
			<div class="nav-logo"><a href="/"><img loading="lazy" class="lazy" data-src="images/nameLogo.png" alt="" title=""></a></div>
                ...
                <div class="content-side col-lg-8 col-md-12 col-sm-12">
					<div class="our-blogs">
						...
						<div class="news-block-three">
							<div class="inner-box">
								<div class="image">
									<a href="news-detail.html"><img src="images/resource/resource/news-7.jpg" alt="" /></a>
								</div>
								<div class="lower-content">
									<ul class="post-meta">
										<li><a href="news-detail.html"><span class="icon fa fa-user"></span> Pablo Villalpando</a></li>
										<li><a href="news-detail.html"><span class="icon fa fa-calendar"></span> November 21, 2021</a></li>
									</ul>
									<h4><a href="news-detail.html">Google now disregards or overlooks all reciprocal links</a></h4>
									<div class="text">It has survived not only five centuries, but also the leap into electronic typesetting. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.</div>
									<div class="btn-box">
										<div class="btn-box-inner">
											<a href="news-detail.html" class="theme-btn btn-style-five"><span class="txt">Learn More</span></a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="news-block-three">
							<div class="inner-box">
								<div class="image">
									<img src="images/resource/resource/news-8.jpg" alt="" />
									<a href="https://www.youtube.com/watch?v=kxPCFljwJws" class="lightbox-image overlay-box"><span class="icon flaticon-play-button"><i class="ripple"></i></span></a>
								</div>
								<div class="lower-content">
									<ul class="post-meta">
										<li><a href="news-detail.html"><span class="icon fa fa-user"></span> Pablo Villalpando</a></li>
									...
									<h4><a href="news-detail.html">Absolute Links vs. Relative Links – SEO Intrinsic Value</a></h4>
									<div class="text">It has survived not only five centuries, but also the leap into electronic typesetting. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.</div>
									<div class="btn-box">
										<div class="btn-box-inner">
											<a href="news-detail.html" class="theme-btn btn-style-five"><span class="txt">Learn More</span></a>
						...
						<div class="news-block-three">
							<div class="inner-box">
								<div class="single-item-carousel owl-carousel owl-theme">
									<div class="image">
										<a href="news-detail.html"><img src="images/resource/resource/news-9.jpg" alt="" /></a>
									</div>
									<div class="image">
										<a href="news-detail.html"><img src="images/resource/resource/news-9.jpg" alt="" /></a>
									</div>
								...
								<div class="lower-content">
									...
									<h4><a href="news-detail.html">How to increase your ROI through scientific SEM?</a></h4>
									<div class="text">It has survived not only five centuries, but also the leap into electronic typesetting. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.</div>
									<div class="btn-box">
										<div class="btn-box-inner">
											<a href="news-detail.html" class="theme-btn btn-style-five"><span class="txt">Learn More</span></a>
						...
						<div class="news-block-four">
							<div class="inner-box" style="background-image:url(images/resource/resource/news-10.jpg)">
								<div class="post-date">19 <span>JUL</span></div>
								<ul class="post-info">
									<li><span class="author-image"><img src="images/resource/resource/author-4.jpg" alt="" /></span>By: Admin</li>
									<li>Category: <span class="theme_color">Web Designer</span></li>
									<li>Comments: 150</li>
								</ul>
								<h3><a href="news-detail.html">How to increase your ROI through scientific SEM?</a></h3>
							</div>
						</div>
    ...
    <footer class="main-footer">
    	...
    	<div class="auto-container">
			...
			<div class="footer-bottom">
				<div class="copyright">Copyright © 2021 Merix by <a href="https://themeforest.net/user/themerange">ThemeRange</a>. All Rights Reserved. All Rights Reserved.</div>
			</div>
